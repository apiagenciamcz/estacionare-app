...
class DetailsReceiptCredit extends React.Component {
    ...
    render() {
        const { date, value, card } = this.props.item
        ...
        return (
            <WhiteCard>
                ...
                <View style={styles.row}>  
                    ...
                    <Text style={[styles.text, { fontSize:16*fontSize }]}>{card}</Text>
                </View>
...
export default connect(mapStateToProps, mapDispatchToProps)(DetailsReceiptCredit)