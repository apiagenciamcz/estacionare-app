...
class Menu extends Component {
  ...
  componentDidMount() {
    ...
    GoogleSignin.configure({
      iosClientId:
        "307321601096-jpocbm5rtt137d4mgpkdi03troq82rb0.apps.googleusercontent.com",
      androidClientId:
        "307321601096-7o2jnm2kpgg3318ri9d1ok3qhinbbhnj.apps.googleusercontent.com"
    }).then(() => {
      dispatch({
      ...
      <View style={styles.container}>
        ...
        <View style={styles.align}>
          <View style={styles.baseProfile}>
            ...
            <Text style={[styles.titleName, { fontSize: 18 * fontSize }]}>
...
function mapDispatchToProps(dispatch) {
  return bindActionCreators(
    { getUser, changeScreen, toggleMenu, getFontSize },
    dispatch
  );
}
