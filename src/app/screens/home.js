        ...
        <View style={styles.cardWhite}>
          <View style={styles.headerHome}>
            <View style={styles.blackBox}>
              <Text style={[styles.labelCash, { fontSize: 12 * fontSize }]}>
                SEU SALDO ATUAL É
              </Text>
              <Text
                style={[
                  styles.titleCash,
                  { fontSize: 22 * fontSize, lineHeight: 26 * fontSize }
                ]}
              >
                {credit}
              </Text>
          ...
          <View style={styles.boxWhite}>
            <View style={styles.rowTimer}>
              ...
              <Text style={[styles.timer, { fontSize: 44 * fontSize }]}>
                {count}
              </Text>
            </View>

            <View style={styles.row}>
              <Text style={[styles.index, { fontSize: 13 * fontSize }]}>
                Cidade
              </Text>
              <Text style={[styles.text, { fontSize: 16 * fontSize }]}>
                {city}
              </Text>
            </View>
