...
import { StyleSheet, View, ImageBackground, StatusBar, TextInput, TouchableOpacity, KeyboardAvoidingView, ScrollView, Dimensions, Platform } from 'react-native'
...
// Actions  
import { handlerCreateFacebook, handlerCreateGoogle, handleCreateLogin, setText, loginGoogleConfigure } from '../../actions/RegisterActions'
                    ...
                    <ImageBackground source={require("../../images/background.png")} style={styles.container}>
                        ...
                        <WhiteCard style={styles.card}>
                            ...
                            <TextInput 
                                ...
                                placeholderTextColor='#2B2B2B' 
                                onChangeText={confirmePassword => this.props.setText(confirmePassword,'CHANGED_CONFIRME_PASSWORD')}
                                value={confirmePassword}/>

                            <TouchableOpacity onPress={() => this.props.handlerCreateFacebook()}>
                                <FacebookButton/>
                            </TouchableOpacity>

                            <TouchableOpacity onPress={() => this.props.handlerCreateGoogle()}>
                                <GmailButton/>
                            </TouchableOpacity>
                        ...
                        <View style={styles.buttons}>
                            <TouchableOpacity onPress={() => this.props.handleCreateLogin(email, password, confirmePassword)} >
...
function mapDispatchToProps(dispatch){
    return bindActionCreators({ handlerCreateFacebook, handlerCreateGoogle, handleCreateLogin, setText, getFontSize, loginGoogleConfigure }, dispatch)
}
