...
import { StyleSheet, Text, View, TouchableOpacity, TextInput, StatusBar, ScrollView, KeyboardAvoidingView, Dimensions, Platform } from 'react-native';
...
// Actions
import { validateNumberCard, validateDateCard, validateCvvCard, validateNameCard, saveCard } from '../../actions/RegisterActions'
                ...
                <ScrollView>
                    <View style={styles.main}>  
                        ...
                        <View style={styles.container}>
                            ...
                            <TitleCard text="MÉTODO DE PAGAMENTO" offset="3" limit="3" style={styles.titles} /> 
                        ...
                        <View style={styles.buttons} >
                            ...
                            <TouchableOpacity onPress={() => this.props.navigation.navigate('RegisterStepFour')} >
...
function mapDispatchToProps(dispatch){
    return bindActionCreators({ validateNumberCard, validateDateCard, validateCvvCard, validateNameCard, saveCard, getFontSize }, dispatch)
}
