...
import { StyleSheet, Text, View, ImageBackground, StatusBar, TouchableOpacity, TextInput, ScrollView, Switch } from 'react-native'
...
// Actions
import { changeTypeAccount, saveTypeAccount } from '../../actions/RegisterActions'
    ...
    render() {
        ...
        return (
            <ImageBackground source={require("../../images/background.png")} style={styles.container}>
                ...
                <Swiper style={styles.wrapper} loop={false} showsButtons={false} activeDot={dotsActive} dots={dots}>

                    <View style={styles.slide} index={2}>
                        <TouchableOpacity style={[styles.bg, typeAccount == "Free" && styles.active]} onPress={() => this.props.changeTypeAccount('Free')}>

                            <View style={styles.titleAlign}>
                                {typeAccount == "Free" && 
                                    <View style={styles.baseIconActive}></View>
                                }
                                {typeAccount == "Free" && 
                                   <FontAwesome style={styles.iconActive}>{Icons.check}</FontAwesome>
                                }
                            ...
                            <View style={styles.list}>
                                <View style={[styles.gray,styles.item]}>
                                    <FontAwesome style={[styles.icon,styles.green]}>{Icons.check}</FontAwesome>
                                    <Text style={styles.text}>Pagamento de paraquímetro</Text>
                                </View>
                                <View style={[styles.white,styles.item]}>
                                    <FontAwesome style={[styles.icon,styles.red]}>{Icons.times}</FontAwesome>
                    ...
                    <View style={styles.slide}  index={1}>
                        <TouchableOpacity style={[ styles.bg, typeAccount == "Premium" && styles.active ]} onPress={() => this.props.changeTypeAccount('Premium')}>
                ...
                <View style={styles.buttons}>
                    <TouchableOpacity onPress={() => this.props.saveTypeAccount(typeAccount)}>
